 ...
 * @author lucas
 */
public class PagamentoFornecedor extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PagamentoFornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
